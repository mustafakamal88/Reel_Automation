...
const VIEW_META: Record<View, { title: string; sub: string }> = {
  ...
  scriptStudio:           { title: 'Script Lab',               sub: 'Build, refine, and structure creator-ready video scripts.' },
  clipStudio:             { title: 'Clip Generator',           sub: 'Upload a video or provide a direct video URL, then download clips' },
  voiceStudio:            { title: 'Voice Studio',             sub: 'Generate, upload, and save project narration' },
  movieStudio:            { title: 'Movie Studio',             sub: 'Assemble project scenes, media, captions, and renders' },
